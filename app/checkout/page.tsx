...
export default function CheckoutPage() {
  ...
  const submitOrder = async () => {
    // No backend yet — orders are simulated locally.
    return true;
  };
          ...
          <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
            ...
            <div className="mt-6 flex gap-3">
              ...
              <Link
                href="/collections"
                onClick={clearCart}
                className="flex-1 rounded bg-stone-900 px-4 py-2 text-center text-xs font-medium uppercase tracking-[0.2em] text-white transition-colors hover:bg-[#b8874f]"
              >
                Shop more
              </Link>
            </div>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        {cart.length === 0 ? (
          <div className="rounded border border-stone-200 bg-white p-10 text-center">
            <p className="text-stone-500 text-base mb-4">Your cart is empty.</p>
            <Link
              href="/collections"
          ...
          <div className="grid gap-8 md:grid-cols-[1fr_340px] items-start">
            ...
            <div className="space-y-8">
              ...
              <section>
                <p className="text-xs font-medium tracking-[0.1em] uppercase text-stone-800 mb-3">
                  Contact info
                </p>
            ...
            <div className="bg-white border border-stone-200 rounded-lg p-5">
              <div className="flex items-center justify-between mb-4">
                <p className="text-xs font-medium tracking-[0.1em] uppercase text-stone-800">
                  Your order
                </p>
