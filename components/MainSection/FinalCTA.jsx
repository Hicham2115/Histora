  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <Link
          href="/collections"
          className={`${notoSans.className} group relative mt-10 flex w-fit items-center gap-3 overflow-hidden border border-stone-900 bg-stone-900 px-8 py-4 text-xs font-light tracking-[0.25em] text-white uppercase transition-colors duration-300 hover:border-[#b8874f]`}
        >
